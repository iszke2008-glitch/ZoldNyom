...
- A minimális elfogadási küszöb **51%-os biztonság** — ez alatt az app **nem enged továbblépni**, automatikusan újraindítja a kamerát, és arra kéri a felhasználót, hogy próbálja újra (közelebbről, jobb megvilágításban).
- Ha a modell technikai okból nem tud lefutni (pl. nincs internet az első betöltéskor), az app szintén nem enged tovább, és jelzi, hogy próbálja újra — így biztosítjuk, hogy tényleg csak felismert szemétről készült fotó juthasson tovább.
...
- A modell 5 kategóriára lett tanítva; nem minden szemétfajtát ismer fel egyenlő pontossággal — a szigorú 51%-os küszöb miatt előfordulhat, hogy néhány valódi szemetes fotót is elutasít, ha a kép nem elég éles vagy közeli.
